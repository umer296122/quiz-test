                            ...
                            <div class="kt-portlet__body kt-portlet__body--fit">
                                <div class="kt-grid  kt-wizard-v2 kt-wizard-v2--white" id="kt_wizard_v2" data-ktwizard-state="first">
                                    ...
                                    <div class="kt-grid__item kt-grid__item--fluid kt-wizard-v2__wrapper">
                                        ...
                                        <form class="kt-form"  novalidate="novalidate" action="{{route('store-quiz')}}" method="POST">
@csrf
                                                ...
                                                <div class="kt-form__section kt-form__section--first">
                                                    <div class="kt-wizard-v2__form">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            {{-- <input type="time" class="form-control" name="quiz_time" placeholder="Quiz Time" value=""> --}}
