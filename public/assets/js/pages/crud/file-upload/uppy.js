...
var KTUppy = (function () {
    ...
    var initUppy3 = function () {
        ...
        uppyDrag.on("complete", function (file) {
            ...
            $.each(file.successful, function (index, value) {
                ...
                if (imageType.test(value.type)) {
                    thumbnail =
                        '<div class="kt-uppy__thumbnail"><img src="' +
                        value.uploadURL +
                        '"/></div>';
                }
                var sizeLabel = "bytes";
                ...
                imagePreview +=
                    '<div class="kt-uppy__thumbnail-container" data-id="' +
                    value.id +
                    '">' +
                    thumbnail +
        ...
        $(document).on(
            ...
            function () {
                ...
                $(
                    id +
                        ' .kt-uppy__thumbnail-container[data-id="' +
                        imageId +
                        '"'
                ).remove();
            }
    ...
    var initUppy5 = function () {
        ...
        $(id + " .uppy-FileInput-input")
            .addClass("kt-uppy__input-control")
            .attr("id", elemId + "_input_control");
        $(id + " .uppy-FileInput-container").append(
            '<label class="kt-uppy__input-label btn btn-label-brand btn-bold btn-font-sm" for="' +
        ...
        uppyMin.on("complete", function (file) {
            $.each(file.successful, function (index, value) {
                ...
                var uploadListHtml =
                    '<div class="kt-uppy__list-item" data-id="' +
                    value.id +
        ...
        $(document).on(
            ...
            function () {
                ...
                $(
                    id + ' .kt-uppy__list-item[data-id="' + itemId + '"'
                ).remove();
            }
        );
    };
