                            ...
                            ?>
                                <div class="card">
                                    <div class="card-header" id="headingOne7">
                                        <div class="card-title" data-toggle="collapse" data-target="#quiz<?php echo e($quiz->id); ?>" aria-expanded="true" aria-controls="quiz<?php echo e($quiz->id); ?>">
                                            ...
                                            </svg> <?php echo e($quiz->name); ?>

                                        </div>
                                    </div>
                                    <div id="quiz<?php echo e($quiz->id); ?>" class="collapse " aria-labelledby="headingOne7" data-parent="#accordionExample7">
                                        <div class="card-body">
                                          Total Question:<?php echo e($totalQuestion); ?><br><br>
                                          Time Duration: <?php echo e($quiz->quiz_time); ?><br>

                                         <a href="<?php echo e(route('show-quiz',[$quiz->id])); ?>"> <button class="btn btn-brand btn-md btn-tall btn-wide kt-font-bold kt-font-transform-u mt-4" type="submit">
                                            Start Quiz
                                        </button> </a>
                                        </div>
                                    </div>
...
<!-- end::Body -->
</body></html><?php /**PATH C:\xampp\htdocs\Quiz-app\resources\views/layouts/quiz-list.blade.php ENDPATH**/ ?>